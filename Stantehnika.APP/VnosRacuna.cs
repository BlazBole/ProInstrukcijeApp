...
namespace Stantehnika.APP
{
    public partial class VnosRacuna : Form
    {
        ...
        {
            Uri htmlFilePath = new Uri(@"C:\Users\blazb\source\repos\ProInstrukcije\Stantehnika.APP\bin\Debug\racun.html"); // Pot do vaše HTML datoteke

            string pdfFilePath = @"C:\Users\blazb\source\repos\ProInstrukcije\Stantehnika.APP\bin\Debug\racun.pdf";
        ...
        public void generirajRacun()
        {
            ...
            try
            {
                ...
                string filePath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "C:\\Users\\blazb\\source\\repos\\ProInstrukcije\\Stantehnika.APP\\bin\\Debug\\racun.html");
                File.WriteAllText(filePath, htmlContent); // Shrani HTML v datoteko
                PretvoriV_PDF();
                ReplaceText("C:\\Users\\blazb\\source\\repos\\ProInstrukcije\\Stantehnika.APP\\bin\\Debug\\racun.pdf", "Created with the DynamicPDF Essentials Edition.", "");
